= Scientific approach <chap:scientific-approach>

== Research project
<research-project>
The graduation project is an individual research project that is
conducted by the student with guidance and regular feedback from the
supervisors.

The project starts with a preliminary phase where the student lays down
the foundations for their research, which includes conducting a study of
...
detailed enough to allow for reproducibility of the work presented in
it. Similarly, in the interest of reproducibility, if the research
involved the creation of source code or data, students are highly
encouraged to publish these in a persistent public repository which is
linked in the report.

In addition to the graduation report, there are two other presentations
as deliverables: (1) a technical presentation, which is given, discussed
and assessed at the A3 (Green light) meeting, and (2) a presentation for
a lay audience, which is given, discussed and assessed at the A4
(Finalisation) meeting.

== Graduation plan (A1) structure
<graduation-plan-a1-structure>
The graduation plan for A1 is a project proposal that must contain the
following elements:

+ A #strong[cover page] with
  + title
  + full name
  + student number
...
<graduation-report-a3-structure>
The exact structure of the thesis, or graduation report, will depend on
the type of work that is involved. However, most good Geomatics theses
contain something similar to the following elements:
...
The implications and reflection of the work that was conducted should be
integrated throughout the thesis. In particular, the implications should
