...
At the start of the graduation process, the student's supervisory team is defined. This team is composed of two supervisors and a co-reader.
...
Students choose this supervisor during the A0 (Registration) phase, either by directly contacting them to agree on a custom topic or by selecting a predefined topic linked to the supervisor.
...
She/he may be predefined based on the selected topic or chosen by the responsible supervisor with student input. 
If the responsible supervisor doesn't hold a PhD degree, the second supervisor must have one. Ideally, the second supervisor is determined at the A0 (Registration) phase and must be confirmed before the A1 (Kick-off).
...
Their role is to assess the quality of the student's work in an unbiased way at the A3 (Green light). 
Preferably, they are not part of the same group(s) as the supervisors. The co-reader is chosen by the supervisors in collaboration with the student. 
The co-reader is preferably defined at the A0 (Preparation) and must be defined before the A3 (Green light).

== Delegate of the Board of Examiners <delegate-of-the-board-of-examiners>
Since the Board of Examiners is responsible for guarding the quality of all examinations, a delegate is appointed by the administration of the Faculty before the A1: a (former) teacher who is familiar with the graduation process and who is not from the same section as your supervisors; this to assure independency. 
