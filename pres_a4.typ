= Public presentation (A4) <chap:pres-a4>
...
Since this competence is not evaluated elsewhere during graduation, the A4 provides an ideal opportunity to demonstrate this skill.
