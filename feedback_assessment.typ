...
More extensive feedback is provided during the A1, A2 and A3 assessments.

One week before the A1 and A3 assessments, the student submits the main deliverables (graduation plan for A1 and graduation report for A3). 
These are presented at the A1 and A3 assessment sessions, where the independent delegate chairs the session. 
...
During the A2 assessment, the supervisors and student conduct a more structured meeting to discuss the progress and (updated) plans. 
...
== Grades <grades>
The grades that are determined at the A3 are provisional and will not yet be announced during the A3. 
